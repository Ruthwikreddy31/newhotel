...
import { LogOut, Crown, Users, TrendingUp, FileText } from "lucide-react";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { ManagerOverview } from "@/components/manager/ManagerOverview";
import { WorkerManagement } from "@/components/manager/WorkerManagement";
      ...
      <div className="bg-gradient-primary text-primary-foreground p-6 shadow-elegant">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">Royal Hostel - Management</h1>
